        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card border border-border rounded-2xl p-6 shadow-md">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="flex-1 h-px bg-border" /><span className="text-[11px] uppercase tracking-wider text-muted-foreground">or</span><div className="flex-1 h-px bg-border" />
            </div>
